...
import { getPlanById, updatePlan } from "../../Service/planService";
...
const EditPlan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/plans"); // go back to plans list
    } catch (err) {
...
// Keep your existing red/white/black theme
const styles = {
  pageWrapper: {
    display: "flex",
